...
class StatsOverview extends BaseWidget
{
    ...
    protected function getStats(): array
    {
        ...
        $omset = Order::whereBetween('created_at', [$startDate, $endDate])->sum('paid_amount');
        ...
        return [
            ...
            Stat::make('Omset (Rp.)', number_format($omset)),
            Stat::make('Pengeluaran (Rp.)', number_format($expense))
        ];
    }
}
